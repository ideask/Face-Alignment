...
class ImageDate():
    def __init__(self, line, image_size=112):
        # 设定图像大小
...
def loadMetaDataList(SrcImage, ratio):
    ...
    trainLabelTxt = os.path.join(SrcImage,'train.txt')
    testLabelTxt = os.path.join(SrcImage,'test.txt')
...
if __name__ == '__main__':
    ...
    landmarkDirs = ['SrcImage/test.txt', 'SrcImage/train.txt']
