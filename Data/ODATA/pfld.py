...
def loadMetaDataList(SrcImage, ratio):
    ...
    trainLabelTxt = os.path.join(SrcImage,'train_pfld.txt')
    testLabelTxt = os.path.join(SrcImage,'test_pfld.txt')
...
if __name__ == '__main__':
    ...
    landmarkDirs = ['SrcImage/test_pfld.txt', 'SrcImage/train_pfld.txt']
